...
public class ReservationService {
    ...
    public Long create(final Reserva reservation) {
    ...
    public void update(final Long id, final Reserva reservation) {
        final Reserva existingReservation = reservationRepository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
